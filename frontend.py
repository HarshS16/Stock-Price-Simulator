...
def main():
    ...
    # st.write("This is an AI tool which verifies articles and checks if they are fake or real")
    ...
    # st.header("Services")
    # st.write("This is the services section.")
...
# tickerDf = tickerData.history(period='1d', start='2010-5-31', end='2025-01-26')
